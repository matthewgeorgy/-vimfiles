...
let s:back = ['#161616', 0]
let s:default = ['#A08563', 0]

let s:margin = ["#262626", 0]
let s:margin_hover = ["#333333", 0]
let s:margin_active = ["#404040", 0]
let s:cursor = ["#40FF40", 0]
let s:highlight = ["#703419", 0]
let s:at_highlight = ["#CDAA7D", 0]
let s:mark = ["#808080", 0]
let s:comment = ["#7D7D7D", 0]
let s:keyword = ["#CD950C", 0]
let s:constant = ["#6B8E23", 0]
let s:preproc = ["#DAB98F", 0]
let s:special = ["#A08563", 0]
" let s:special = ["#FF0000", 0]
let s:bar = ["#CACACA", 0]
let s:bar_active = ["#A8A8A8", 0]
let s:base = ["#000000", 0]
...
call s:HL('ColorColumn', s:margin, s:margin)
...
if version >= 700
  ...
  call s:HL('Pmenu', s:default, s:margin)
